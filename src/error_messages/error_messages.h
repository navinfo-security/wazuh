...
#define INVALID_RKCL_NAME  "(1251): Invalid header read: '%s'."
...
#define INVALID_RKCL_VAR   "(1254): Invalid variable read : '%s'."
#define INVALID_RKCL_PROF  "(1255): Invalid profile read: '%s'."
