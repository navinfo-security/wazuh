...
static const char *SQL_STMT[] = {
    ...
    "INSERT INTO scan_info (module, first_start, first_end, start_scan, end_scan, fim_first_check, fim_second_check, fim_third_check, need_restart) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?);",
    "UPDATE scan_info SET first_start = ?, start_scan = ? WHERE module = ?;",
    "UPDATE scan_info SET first_end = ?, end_scan = ?, need_restart = 0 WHERE module = ?;",
